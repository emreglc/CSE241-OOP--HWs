...
TetrisAdapter<Blueprint>::TetrisAdapter(const int height, const int width){
...
template<class Blueprint>
TetrisAdapter<Blueprint>::TetrisAdapter(){
...
template<class Blueprint>
void TetrisAdapter<Blueprint>::createBoard(){
...
template<class Blueprint>
void TetrisAdapter<Blueprint>::animate(Tetromino &tetro, char shape){
...
template<class Blueprint>
void TetrisAdapter<Blueprint>::animate(Tetromino &tetro){
...
template<class Blueprint>
bool TetrisAdapter<Blueprint>::canFall(Tetromino &tetro) const{
...
template<class Blueprint>
void TetrisAdapter<Blueprint>::drawBoard() const{
...
template<class Blueprint>
void TetrisAdapter<Blueprint>::placeTetromino(Tetromino &tetro){
...
template<class Blueprint>
void TetrisAdapter<Blueprint>::removeTetromino(Tetromino &tetro, const int x, const string place){
...
template<class Blueprint>
void TetrisAdapter<Blueprint>::moveTetromino(Tetromino &tetro, const int x){
...
template<class Blueprint>
const bool TetrisAdapter<Blueprint>::isGameOver(Tetromino &tetro){
...
template<class Blueprint>
void TetrisAdapter<Blueprint>::writeToFile(fstream &file){
...
template<class Blueprint>
void TetrisAdapter<Blueprint>::readFromFile(fstream &file){
